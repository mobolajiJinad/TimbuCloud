    ...
    <>
      ...
      <main className="mt-6 flex h-[70vh] flex-col items-center justify-center px-[5%] pb-5 sm:flex-row sm:justify-around">
        ...
        <div className="order-2 text-center sm:order-1 sm:w-1/2 sm:px-5 sm:text-start">
          <h3 className="mb-4 text-2xl font-bold text-dark-cyan sm:text-left sm:text-opaque-white">
            T5 Mini Smart watch
          </h3>
          ...
          <p className="block whitespace-normal break-words text-xl font-semibold text-opaque-white sm:hidden">
          ...
          <NavHashLink
            smooth
            to="#FeaturedProducts"
            className="mt-8 inline-block rounded-3xl bg-dark-cyan px-5 py-2 text-xl capitalize text-white sm:mx-0"
          >
            explore products
          </NavHashLink>
        </div>
